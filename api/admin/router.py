...
DEFAULT_SETTINGS = {
    "website": {
        ...
        "prelaunch_text": "Bethel is completing corporate, contractual and regulatory work with professional advisers. Public registration and onboarding are available through the secure Bethel onboarding process. Account activation remains subject to applicable identity verification, compliance, eligibility, legal, payment, trading-account linking, copier activation, and final Super Admin approval requirements. Live trading information shown below is Bethel-reported read-only telemetry and is not represented as independent third-party verification.",
